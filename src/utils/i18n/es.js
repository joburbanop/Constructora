const es = {
  ...
  todos_proyectos: {
    ...
    titulo_seccion: 'Explorar Proyectos',
    ...
    mostrar_filtros: 'Mostrar filtros',
  },
  ...
  stats: {
    ...
    clientes_desc: 'Compromiso total',
    garantia_calidad: 'Garantía de calidad',
    garantia_desc: 'Compromiso total',
    titulo_principal: 'Nuestros Logros',
    subtitulo: 'Más de una década construyendo sueños y transformando espacios',
    ...
    confianza: 'Confianza',
    confianza_desc: 'Compromiso total con nuestros clientes',
    cta_titulo: '¿Listo para construir tu sueño?',
    cta_descripcion: 'Construye con la mejor constructora del sur occidente colombiano',
    cta_contactar: 'Contáctanos',
...
casa_usa_primera_detalle:{
 ...
 info_AreaPrecioUbic: {
  ...
  subtitulo_seccion: 'Descubre los detalles más importantes',
  rincon_lago: {
    area: 'Área',
...
videos: {
  ...
  coral: {
    ...
    puertas_sol: {
      ...
      slide4_title: 'Excelentes vías de acceso',
      slide4_subtitle: 'Todos los servicios públicos funcionales. Ubicación estratégica para inversión comercial y residencial',
      slide5_title: 'Facilidad de pago a 12 meses',
      slide5_subtitle: 'Últimos lotes disponibles con las mejores condiciones de financiación del mercado',
      slide6_title: '6 zonas verdes y espacios recreativos',
      slide6_subtitle: 'Disfrute de un ambiente familiar y agradable con amplias zonas verdes distribuidas estratégicamente',
      slide7_title: 'Inversión comercial y residencial',
      slide7_subtitle: 'Ideal para inversión con alta rentabilidad. Agende su visita exclusiva: 3204210000',
